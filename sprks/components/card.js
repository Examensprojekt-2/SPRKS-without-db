  ...
  return (
    <div class='mx-auto md:w-auto md:max-w-5xl pb-4 bg-transparent max-h-screen shadow-sm flex-row rounded-t-lg relative ml-3 mr-3'>
      ...
      <div class='text-center'>
        <button class='bg-gray-200 hover:bg-gray-300 text-black font-bold py-2 px-4 rounded-full' onClick={addLike}>
          ...
          {/* If gameLikes isn't null, map number of likes */}
          { gameLikes != null && (
            gameLikes.map(like => {
              numOfLikes++;
            })
          ...
          { gameLikes != null ? (
              <p class='text-center text-gray-200'>{numOfLikes} likes</p>
            ) : (
              <p class='text-center text-gray-200'>0 likes</p>
            )}
      </div>
