          ...
          <div class="flex-grow">
            ...
            <div class="w-full">
              <div class="flex cursor-pointer my-1 hover:bg-blue-lightest rounded">
                ...
                <div class="w-4/5 h-10 py-3 px-1">
                  <p class="hover:text-blue-dark">{users[0].friends[0].name}</p>
                </div>
              ...
              <div class="flex cursor-pointer my-1 hover:bg-blue-lightest rounded">
                ...
                <div class="w-4/5 h-10 py-3 px-1">
                  <p class="hover:text-blue-dark">{users[0].friends[1].name}</p>
                </div>
                <div class="w-1/5 h-10 text-right p-3">
              ...
              <div class="flex cursor-pointer my-1 hover:bg-blue-lightest rounded">
                ...
                <div class="w-4/5 h-10 py-3 px-1">
                  <p class="hover:text-blue-dark">{users[0].friends[2].name}</p>
                </div>
                <div class="w-1/5 h-10 text-right p-3">
                  <p class="text-sm text-grey-dark">Member</p>
                </div>
              ...
              <div class="flex cursor-pointer my-1 hover:bg-blue-lightest rounded">
                ...
                <div class="w-4/5 h-10 py-3 px-1">
                  <p class="hover:text-blue-dark">{users[0].friends[3].name}</p>
                </div>
                <div class="w-1/5 h-10 text-right p-3">
                  <p class="text-sm text-grey-dark">Team</p>
                </div>
              ...
              <div class="flex my-1 cursor-pointer hover:bg-blue-lightest rounded">
                ...
                <div class="w-4/5  h-10 py-3 px-1">
                  <p class="hover:text-blue-dark">{users[0].friends[4].name}</p>
                </div>
                <div class="w-1/5 h-10 text-right p-3">
                  <p class="text-sm text-grey-dark">Member</p>
                </div>
